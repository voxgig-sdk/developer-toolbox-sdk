-- DeveloperToolbox SDK UrlTool entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local UrlToolEntity = {}
UrlToolEntity.__index = UrlToolEntity


function UrlToolEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, UrlToolEntity)
  self._name = "url_tool"
  self._client = client
...
function UrlToolEntity:get_name()
  return self._name
end


function UrlToolEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return UrlToolEntity.new(self._client, opts)
end
...
function UrlToolEntity:mark_deleted()
  self._deleted = true
end


function UrlToolEntity:deleted()
  return true == self._deleted
end


function UrlToolEntity:data_set(args)
  if args ~= nil then
...
function UrlToolEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function UrlToolEntity:match_set(args)
  if args ~= nil then
...
function UrlToolEntity:match_get()
...
function UrlToolEntity:stream(action, args, callopts)
...
function UrlToolEntity:_run_op(ctx, post_done)
  local utility = self._utility
