...
function runner.env_override(m)
  local live = runner.getenv("DEVELOPER_TOOLBOX_TEST_LIVE")
  local override = runner.getenv("DEVELOPER_TOOLBOX_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("DEVELOPER_TOOLBOX_TEST_EXPLAIN")
