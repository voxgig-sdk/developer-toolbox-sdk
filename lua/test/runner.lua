...
function runner.env_override(m)
  local live = runner.getenv("DEVELOPERTOOLBOX_TEST_LIVE")
  local override = runner.getenv("DEVELOPERTOOLBOX_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("DEVELOPERTOOLBOX_TEST_EXPLAIN")
