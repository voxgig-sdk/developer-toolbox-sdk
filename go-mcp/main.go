// Command DeveloperToolbox-mcp is an MCP server exposing the DeveloperToolbox
// SDK as MCP tools.
//
// Two tools are registered:
//
//	DeveloperToolbox_list  — list records of an entity
//	DeveloperToolbox_load  — load a single record of an entity
//
