...
type Args struct {
	Entity string         `json:"entity" jsonschema:"generator | url_tool | utility"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.DeveloperToolboxSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "developer-toolbox_list",
		Description: "List records from DeveloperToolbox. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "developer-toolbox_load",
		Description: "Load a single record from DeveloperToolbox. " +
...
func runOp(client *sdk.DeveloperToolboxSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.DeveloperToolboxSDK, name string) (sdk.DeveloperToolboxEntity, error) {
	switch strings.ToLower(name) {
	case "generator":
		return client.Generator(nil), nil
	case "url_tool":
		return client.UrlTool(nil), nil
	case "utility":
