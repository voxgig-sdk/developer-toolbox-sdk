...
const testSeed = `map[string]any{"entity": map[string]any{"generator": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "url_tool": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "utility": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
