...
func TestUrlToolEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		urlToolRef01Data = core.ToMapAny(entityData(urlToolRef01DataResult))
...
func url_toolBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("DEVELOPER_TOOLBOX_TEST_URL_TOOL_ENTID")
	...
	idmapResolved := core.ToMapAny(env["DEVELOPER_TOOLBOX_TEST_URL_TOOL_ENTID"])
