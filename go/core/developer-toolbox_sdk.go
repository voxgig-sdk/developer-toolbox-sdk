...
type DeveloperToolboxSDK struct {
	Mode     string
...
func (sdk *DeveloperToolboxSDK) OptionsMap() map[string]any {
...
func (sdk *DeveloperToolboxSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *DeveloperToolboxSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *DeveloperToolboxSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *DeveloperToolboxSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *DeveloperToolboxSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *DeveloperToolboxSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("DeveloperToolboxSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *DeveloperToolboxSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *DeveloperToolboxSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("DeveloperToolboxSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *DeveloperToolboxSDK {
	...
	sdk := NewDeveloperToolboxSDK(sdkopts)
	sdk.Mode = "test"
