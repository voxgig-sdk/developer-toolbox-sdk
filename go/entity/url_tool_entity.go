...
func NewUrlToolEntity(client *core.DeveloperToolboxSDK, entopts map[string]any) *UrlToolEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *UrlToolEntity) GetName() string { return e.name }
...
func (e *UrlToolEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *UrlToolEntity) Deleted() bool {
	return e.deleted
}


func (e *UrlToolEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewUrlToolEntity(e.client, opts)
}

func (e *UrlToolEntity) Data(args ...any) any {
...
func (e *UrlToolEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an UrlTool; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *UrlToolEntity) DataTyped(data ...UrlTool) UrlTool {
	if len(data) > 0 {
		return typedFrom[UrlTool](e.Data(asMap(data[0])))
	}
	return typedFrom[UrlTool](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through UrlTool (all fields
// optional at the wire level).
func (e *UrlToolEntity) MatchTyped(match ...UrlTool) UrlTool {
	if len(match) > 0 {
		return typedFrom[UrlTool](e.Match(asMap(match[0])))
	}
	return typedFrom[UrlTool](e.Match())
}
...
func (e *UrlToolEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *UrlToolEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *UrlToolEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *UrlToolEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// UrlToolCreateData and returns an UrlTool. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *UrlToolEntity) CreateTyped(reqdata UrlToolCreateData, ctrl map[string]any) (UrlTool, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return UrlTool{}, err
	}
	return typedFrom[UrlTool](res), nil
}



func (e *UrlToolEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *UrlToolEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *UrlToolEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
