...
type GeneratorEntity struct {
	name    string
	client  *core.DeveloperToolboxSDK
...
func NewGeneratorEntity(client *core.DeveloperToolboxSDK, entopts map[string]any) *GeneratorEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GeneratorEntity) GetName() string { return e.name }
...
func (e *GeneratorEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GeneratorEntity) Deleted() bool {
	return e.deleted
}


func (e *GeneratorEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGeneratorEntity(e.client, opts)
}

func (e *GeneratorEntity) Data(args ...any) any {
...
func (e *GeneratorEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Generator; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GeneratorEntity) DataTyped(data ...Generator) Generator {
	if len(data) > 0 {
		return typedFrom[Generator](e.Data(asMap(data[0])))
	}
	return typedFrom[Generator](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Generator (all fields
// optional at the wire level).
func (e *GeneratorEntity) MatchTyped(match ...Generator) Generator {
	if len(match) > 0 {
		return typedFrom[Generator](e.Match(asMap(match[0])))
	}
	return typedFrom[Generator](e.Match())
}
...
func (e *GeneratorEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GeneratorEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GeneratorLoadMatch and returns an Generator. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GeneratorEntity) LoadTyped(reqmatch GeneratorLoadMatch, ctrl map[string]any) (Generator, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Generator{}, err
	}
	return typedFrom[Generator](res), nil
}




func (e *GeneratorEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// GeneratorListMatch and returns []Generator. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *GeneratorEntity) ListTyped(reqmatch GeneratorListMatch, ctrl map[string]any) ([]Generator, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Generator](res), nil
}




func (e *GeneratorEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// GeneratorCreateData and returns an Generator. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *GeneratorEntity) CreateTyped(reqdata GeneratorCreateData, ctrl map[string]any) (Generator, error) {
...
func (e *GeneratorEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GeneratorEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GeneratorEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
