...
// DeveloperToolbox SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (DeveloperToolboxSDK::test)
...
{
    private const SDK_CLASS = 'DeveloperToolboxSDK';
    ...
    private const SDK_BASE = 'developertoolbox_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../developertoolbox_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
