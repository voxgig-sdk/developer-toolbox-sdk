...
class UrlToolEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set DEVELOPERTOOLBOX_TEST_URL_TOOL_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function url_tool_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("DEVELOPERTOOLBOX_TEST_URL_TOOL_ENTID");
