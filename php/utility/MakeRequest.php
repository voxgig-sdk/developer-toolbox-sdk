...
// DeveloperToolbox SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class DeveloperToolboxMakeRequest
{
    public static function call(DeveloperToolboxContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new DeveloperToolboxResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new DeveloperToolboxResponse($fetched);
        } else {
