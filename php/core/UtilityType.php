...
// DeveloperToolbox SDK utility type

class DeveloperToolboxUtility
{
    ...
    public static function copy(DeveloperToolboxUtility $src): DeveloperToolboxUtility
    {
        $u = new DeveloperToolboxUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
