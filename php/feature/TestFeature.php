...
// DeveloperToolbox SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class DeveloperToolboxTestFeature extends DeveloperToolboxBaseFeature
{
    ...
    public function init(DeveloperToolboxContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (DeveloperToolboxContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = DeveloperToolboxParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (DeveloperToolboxContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(DeveloperToolboxContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = DeveloperToolboxParam::call($ctx, $k);
