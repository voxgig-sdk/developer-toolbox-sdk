...
// DeveloperToolbox SDK streaming feature
...
class DeveloperToolboxStreamingFeature extends DeveloperToolboxBaseFeature
{
    ...
    private function _iterate(DeveloperToolboxResult $result): \Generator
    {
    ...
    private function _streamable(DeveloperToolboxContext $ctx): bool
    {
