...
// DeveloperToolbox SDK clienttrack feature
...
class DeveloperToolboxClienttrackFeature extends DeveloperToolboxBaseFeature
{
    ...
    public function PostConstruct(DeveloperToolboxContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'DeveloperToolbox-SDK';
