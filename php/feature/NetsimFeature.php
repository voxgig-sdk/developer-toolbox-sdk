...
// DeveloperToolbox SDK netsim feature
...
class DeveloperToolboxNetsimFeature extends DeveloperToolboxBaseFeature
{
    ...
    private function _simulate(DeveloperToolboxContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(DeveloperToolboxContext $ctx, array $applied): void
    {
        $client = $this->client;
