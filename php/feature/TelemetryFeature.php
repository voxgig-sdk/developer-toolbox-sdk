...
// DeveloperToolbox SDK telemetry feature
...
class DeveloperToolboxTelemetryFeature extends DeveloperToolboxBaseFeature
{
    ...
    private function _close(DeveloperToolboxContext $ctx, bool $ok): void
    {
