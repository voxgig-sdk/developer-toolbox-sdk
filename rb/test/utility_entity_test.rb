...
class UtilityEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set DEVELOPERTOOLBOX_TEST_UTILITY_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def utility_basic_setup(extra)
  ...
  entid_env_raw = ENV["DEVELOPERTOOLBOX_TEST_UTILITY_ENTID"]
