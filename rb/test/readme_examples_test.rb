...
#      offline in seeded test mode (DeveloperToolboxSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "DeveloperToolbox_sdk.rb")
  SDK_CLASS = "DeveloperToolboxSDK"
