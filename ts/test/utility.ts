...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.DEVELOPERTOOLBOX_TEST_LIVE ||
    'TRUE' === process.env.DEVELOPERTOOLBOX_TEST_OVERRIDE
  ) {
  ...
  m.DEVELOPERTOOLBOX_TEST_EXPLAIN = process.env.DEVELOPERTOOLBOX_TEST_EXPLAIN || m.DEVELOPERTOOLBOX_TEST_EXPLAIN
