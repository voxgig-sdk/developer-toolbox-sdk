...
(0, node_test_1.describe)('UrlToolEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != url_tool_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/url_tool/UrlToolTestData.json');
    ...
    let idmap = transform(['url_tool01', 'url_tool02', 'url_tool03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=UrlToolEntity.test.js.map