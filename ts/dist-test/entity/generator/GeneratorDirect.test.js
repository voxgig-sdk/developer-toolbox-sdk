...
(0, node_test_1.describe)('GeneratorDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.DeveloperToolboxSDK({
    ...
    (0, node_test_1.test)('direct-load-generator', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-generator', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-generator', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-generator', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function liveScenariosActive() { return false && process.env.DEVELOPER_TOOLBOX_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.DeveloperToolboxSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['DEVELOPER_TOOLBOX_TEST_GENERATOR_ENTID'];
    ...
    const client = new __1.DeveloperToolboxSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=GeneratorDirect.test.js.map