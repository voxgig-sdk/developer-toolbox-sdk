...
function envOverride(m) {
    if ('TRUE' === process.env.DEVELOPER_TOOLBOX_TEST_LIVE ||
        'TRUE' === process.env.DEVELOPER_TOOLBOX_TEST_OVERRIDE) {
    ...
    m.DEVELOPER_TOOLBOX_TEST_EXPLAIN = process.env.DEVELOPER_TOOLBOX_TEST_EXPLAIN || m.DEVELOPER_TOOLBOX_TEST_EXPLAIN;
    return m;
}
