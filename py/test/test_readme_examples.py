# DeveloperToolbox SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions DeveloperToolboxSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both DeveloperToolboxSDK(...) and DeveloperToolboxSDK.test(...) become
#      DeveloperToolboxSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "developertoolbox_sdk"
_SDK_CLASS = "DeveloperToolboxSDK"
