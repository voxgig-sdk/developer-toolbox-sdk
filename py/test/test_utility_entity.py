    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set DEVELOPER_TOOLBOX_TEST_UTILITY_ENTID JSON to run live")
        client = setup["client"]
        ...
        utility_ref01_data = helpers.to_map(runner.entity_data(utility_ref01_ent.create(utility_ref01_data, None)))
...
def _utility_basic_setup(extra):
    ...
    _entid_env_raw = os.environ.get(
        "DEVELOPER_TOOLBOX_TEST_UTILITY_ENTID")
    ...
    idmap_resolved = helpers.to_map(
        env.get("DEVELOPER_TOOLBOX_TEST_UTILITY_ENTID"))
