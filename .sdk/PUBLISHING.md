...
|---|---|---|
| `ts/` | @voxgig-sdk/developer-toolbox-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/developer-toolbox-sdk \
      --repository voxgig-sdk/developer-toolbox-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/developer-toolbox-sdk` shows it, and
`npm trust revoke @voxgig-sdk/developer-toolbox-sdk --id=<id>` removes it.
