...
from projectname_sdk.core.control import DeveloperToolboxControl
...
class DeveloperToolboxContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = DeveloperToolboxControl()
        ...
        if isinstance(sp, DeveloperToolboxSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, DeveloperToolboxResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, DeveloperToolboxResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return DeveloperToolboxOperation({})
    ...
    def make_error(self, code, msg):
        return DeveloperToolboxError(code, msg, self)
