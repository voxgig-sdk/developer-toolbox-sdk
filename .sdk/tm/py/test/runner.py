...
class DeveloperToolboxTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = DeveloperToolboxTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = DeveloperToolboxTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = DeveloperToolboxTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
