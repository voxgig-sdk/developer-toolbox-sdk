...
// DeveloperToolbox SDK utility: graphql
//
...
class DeveloperToolboxGraphql
{
    ...
    // equivalent.
    public static function body(DeveloperToolboxContext $ctx): mixed
    {
    ...
    public static function errors(DeveloperToolboxContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
