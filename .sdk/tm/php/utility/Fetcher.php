...
// DeveloperToolbox SDK utility: fetcher

class DeveloperToolboxFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; DeveloperToolboxSDK/1.0)';
    ...
    public static function call(DeveloperToolboxContext $ctx, string $fullurl, array $fetchdef): array
    {
