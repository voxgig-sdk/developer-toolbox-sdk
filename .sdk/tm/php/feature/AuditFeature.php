...
// DeveloperToolbox SDK audit feature
...
class DeveloperToolboxAuditFeature extends DeveloperToolboxBaseFeature
{
    ...
    private function _emit(DeveloperToolboxContext $ctx, string $outcome): void
    {
