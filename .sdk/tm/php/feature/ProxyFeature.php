...
// DeveloperToolbox SDK proxy feature
...
class DeveloperToolboxProxyFeature extends DeveloperToolboxBaseFeature
{
    ...
    public function init(DeveloperToolboxContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (DeveloperToolboxContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
