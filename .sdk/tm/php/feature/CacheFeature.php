...
// DeveloperToolbox SDK cache feature
...
class DeveloperToolboxCacheFeature extends DeveloperToolboxBaseFeature
{
    ...
    private function _through(DeveloperToolboxContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
