...
// DeveloperToolbox SDK ratelimit feature
...
class DeveloperToolboxRatelimitFeature extends DeveloperToolboxBaseFeature
{
    ...
    private function _acquire(DeveloperToolboxContext $ctx): void
    {
    ...
    private function _track(DeveloperToolboxContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
