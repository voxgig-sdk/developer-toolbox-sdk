...
// DeveloperToolbox SDK timeout feature
...
class DeveloperToolboxTimeoutFeature extends DeveloperToolboxBaseFeature
{
    ...
    private function _with_timeout(DeveloperToolboxContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(DeveloperToolboxContext $_ctx, float $ms): void
    {
        $client = $this->client;
