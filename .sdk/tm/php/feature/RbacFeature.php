...
// DeveloperToolbox SDK rbac feature
...
class DeveloperToolboxRbacFeature extends DeveloperToolboxBaseFeature
{
    ...
    private function _required(DeveloperToolboxContext $ctx): ?string
    {
    ...
    private function _reject(DeveloperToolboxContext $ctx, string $required): void
    {
    ...
    private function _track(DeveloperToolboxContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
