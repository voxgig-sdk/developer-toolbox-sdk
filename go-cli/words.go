...
func registerSDKWords(r *eng.Registry, client *sdk.DeveloperToolboxSDK) {
...
func runOp(client *sdk.DeveloperToolboxSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
